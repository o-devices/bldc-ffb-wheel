//
// Created by olukelo on 01.05.2020.
//

#include "effects_constants.h"
#include "usbd_conf.h"

__ALIGN_BEGIN uint8_t HidReportDescriptor[USBD_CUSTOM_HID_REPORT_DESC_SIZE] __ALIGN_END = {
    0x05, 0x01,                     // Usage Page (Generic Desktop)
    0x09, 0x04,                     // Usage (Joystick)
    0xA1, 0x01,                         // Collection (Application)
    0x85, REPORT_JOYSTICK,                  // Report ID (1)
    ...
    0x85, REPORT_PID_STATE,//     Report ID (18)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_SET_CONDITION,//     Report ID (19)
    0x09, 0x22,        //     Usage (0x22)
    0x15, 0x01,        //     Logical Minimum (1)
    0x25, 0x28,        //     Logical Maximum (40)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_SET_PERIODIC,//     Report ID (20)
    0x09, 0x22,        //     Usage (0x22)
    0x15, 0x01,        //     Logical Minimum (1)
    0x25, 0x28,        //     Logical Maximum (40)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_SET_CONSTANT_FORCE,        //     Report ID (21)
    0x09, 0x22,        //     Usage (0x22)
    0x15, 0x01,        //     Logical Minimum (1)
    0x25, 0x28,        //     Logical Maximum (40)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_SET_RAMP_FORCE,        //     Report ID (22)
    0x09, 0x22,        //     Usage (0x22)
    0x15, 0x01,        //     Logical Minimum (1)
    0x25, 0x28,        //     Logical Maximum (40)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_EFFECT_OPERATION,        //     Report ID (26)
    0x09, 0x22,        //     Usage (0x22)
    0x15, 0x01,        //     Logical Minimum (1)
    0x25, 0x28,        //     Logical Maximum (40)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0x91, 0x02,        //     Output (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position,Non-volatile)
    0xC0,              //   End Collection
    0x09, 0x90,        //   Usage (PID Block Free Repo)
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_PID_BLOCK_FREE,        //     Report ID (27)
    0x09, 0x22,        //     Usage (0x22)
    0x25, 0x28,        //     Logical Maximum (40)
    0x15, 0x01,        //     Logical Minimum (1)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0x91, 0x02,        //     Output (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position,Non-volatile)
    0xC0,              //   End Collection
    0x09, 0x96,        //   Usage (PID ODrive Control)
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_PID_DEVICE_CONTROL,//     Report ID (28)
    ...
    0x91, 0x00,        //     Output (Data,Array,Abs,No Wrap,Linear,Preferred State,No Null Position,Non-volatile)
    0xC0,              //   End Collection
    0x09, 0x7D,        //   Usage (ODrive Gain Report)
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_DEVICE_GAIN,//     Report ID (29)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_CREATE_NEW_EFFECT,        //     Report ID (17)
    0x09, 0x25,        //     Usage (0x25)
    0xA1, 0x02,        //     Collection (Logical)
    0x09, 0x26,        //       Usage (0x26) Constant Force
    0x09, 0x27,        //       Usage (0x27) Ramp
    0x09, 0x30,        //       Usage (0x30) Square
    0x09, 0x31,        //       Usage (0x31) Sine
    0x09, 0x32,        //       Usage (0x32) Triangle
    0x09, 0x33,        //       Usage (0x33) Sw UP
    0x09, 0x34,        //       Usage (0x34) Sw DOWN
    0x09, 0x40,        //       Usage (0x40) Spring
    0x09, 0x41,        //       Usage (0x41) Damper
    0x09, 0x42,        //       Usage (0x42) Inertia
    0x09, 0x43,        //       Usage (0x43) Friction
    0x09, 0x29,        //       Usage (0x29)
    0x25, 0x0C,        //       Logical Maximum (12)
    0x15, 0x01,        //       Logical Minimum (1)
    0x35, 0x01,        //       Physical Minimum (1)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_PID_BLOCK_LOAD,        //     Report ID (18)
    0x09, 0x22,        //     Usage (0x22)
    0x25, 0x28,        //     Logical Maximum (40)
    0x15, 0x01,        //     Logical Minimum (1)
    0x35, 0x01,        //     Physical Minimum (1)
    ...
    0xA1, 0x02,        //   Collection (Logical)
    0x85, REPORT_PID_POOL,//     Report ID (19)
    ...
    0xC0,              //   End Collection
    0x05, 0x0F,        //   Usage Page (Vendor)
    0x09, 0x00,        //   Usage (Vendor)
    0xA1, 0x01,                     // Collection 0x01
    0x85, REPORT_GENERIC,           //   Report ID
